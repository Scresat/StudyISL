...
class Classifier:
    ...
    def simpleGesture(self, hand_landmarks, whichhand):
        ...
        # creating an array of values that will be passed onto the neural network model
